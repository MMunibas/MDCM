...
# FOLDERS
ROOT=/home/devereux/MDCM-release/examples/multi-conformer
...
\$BINDIR/pcubefit.x -greedy -mtpfile \$MTPFILE -esp \$PCUBE -dens \$DCUBE -nacmin 1 -nacmax \$MAXCHG -atom \$ATOMINDEX -ntry \$NTRY -onlymultipoles -v -sym > atom$i-fit.out
" > $SCRIPT
