...
!    fragments, in which case RMSE in reconstructed file is incorrect)
    ...
    do try = 1,num_trials
        ...
        if(RMSE_tmp < RMSE_best) then
            ...
            call write_xyz_file(charges(1:qdim),filename=input_xyzfile(1:ppos)//"_refined.xyz")
...
if(num_charges_max > num_charges_max_multipole*natmfit) num_charges_max = num_charges_max_multipole*natmfit
